...
from .abstract_display import AbstractDisplay, DeviceConfigLike
...
class MockDisplay(AbstractDisplay):
    ...
    def _simulate_eink_frame(self, image: Image.Image) -> Image.Image:
        ...
        image_settings = cast(
            Mapping[str, object],
            self.device_config.get_config("image_settings") or {},
        )
        inky_saturation_raw = image_settings.get("inky_saturation", 0.5)
        inky_saturation = (
