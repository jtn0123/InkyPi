...
- **Status:** GitPython is bumped to `3.1.47` in this PR; the unpatched `pip` advisory remains tracked separately in `docs/security/pip-ghsa-58qw-9mgm-455v-tracking.md`.
- **Effort:** S
