...
class TestBrowserCommandCarriesTheWait:
    def _command(self, render_wait_ms):
...
class TestBlankDetection:
    ...
    def test_photographic_image_is_not_blank(self):
...
class TestSkipIfBlankBehaviour:
    def _generate(self, monkeypatch, *, captured, settings):
        monkeypatch.setattr(
    ...
    def test_blank_capture_returns_none_when_enabled(self, monkeypatch):
    ...
    def test_blank_capture_is_still_displayed_when_disabled(self, monkeypatch):
    ...
    def test_non_blank_capture_is_displayed_with_the_setting_on(self, monkeypatch):
        image = Image.new("RGB", (40, 30), "white")
    ...
    def test_failed_capture_still_raises(self, monkeypatch):
    ...
    def test_render_wait_is_passed_to_the_backend(self, monkeypatch):
        seen = {}
